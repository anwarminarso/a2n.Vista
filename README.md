...
Not started / skeleton only: the remaining UI adapters (Pillar 2, client half — DataTables.NET is real; AG Grid, MudBlazor, Telerik, Syncfusion, TanStack, PrimeNG, OData, GraphQL are scaffolds), observability (OpenTelemetry), versioning/deprecation, and a CI workflow.
