 ...
 */
function discontinuedBadgeRenderer(params) {
    const badge = document.createElement('span');
    const isDiscontinued = params.value === true || params.value === 1 || params.value === 'true' || params.value === '1';
 ...
 */
function productLinkRenderer(params) {
...
function bootstrap() {
    ...
    renderNav('custom-renderer', getRequiredElement('nav'));
